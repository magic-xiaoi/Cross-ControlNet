...
class BasicTransformerBlock(nn.Module):
    ...
    def get_qkv(
        ...
        new_dict.update(cross_attention_kwargs)
        ...
        # cross_attention_kwargs is empty by default, so we can reuse it to pass
        # extra arguments (e.g., for custom Q/K/V computation) to self-attention.
    ...
    def forward(
        ...
        new_dict1.update(cross_attention_kwargs)
